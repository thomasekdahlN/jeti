...
If it says Error instead of OK behind the App name. Press the CMD button to see the debug log. Important: If reporting errors to me, you have to include a screenshot of this debug screen.
